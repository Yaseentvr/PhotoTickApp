...
class PersonalAssistants extends StatefulWidget {
  ...
  const PersonalAssistants({Key? key, required this.clientId}) : super(key: key);
...
class _PersonalAssistantsState extends State<PersonalAssistants> {
  ...
  Future<void> _loadPersonalAssistantsFromHive() async {
    ...
    if (client != null && client.personalAssistants != null) {
      setState(() {
        selectedAssistants = client.personalAssistants!.cast<PersonalAssistantModel>();
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(assistant.assistantPhone, style: TextStyle(color: Colors.grey[600])),
                    ),
                  ),
                );
              },
                    ...
                    content: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected = tempSelected.any((ass1) => ass1.id == assistant.id);
                            ...
                            onChanged: (bool? value) {
                              setStateDialog(() {
                                if (value == true) {
                                  ...
                                  tempSelected.removeWhere((ass) => ass.id == assistant.id);
                                }
                              });
                            },
                          );
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Assistants have been saved!')),
                          );
                        },
                      ),
                    ],
  ...
  Future<void> savePersonalAssistants(List<AssistantModel> assistants, String clientId) async {
    final box = await Hive.openBox<ClientModel>('Client_Box');
    List<PersonalAssistantModel> personalAssistants = assistants.map((assistant) {
